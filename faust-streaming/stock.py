...
json_file = open('/home/BigData/Algorithmic-Trading/faust-streaming/model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("/home/BigData/Algorithmic-Trading/faust-streaming/model.h5")
